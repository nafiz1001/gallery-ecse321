...
/**
 * 
 * @author antonianistor This class tests methods from IdentityService
 */
...
//			email=Integer.toString(emailAsNum);
		...
		lenient().when(identityRepository.findIdentityByEmail(anyString()))
	...
	/**
	 * Tests a successful Identity creation
	 */
	@Test
	...
	/**
	 * Tests trying to create an Identity with an invalid email
	 */
	@Test
	...
	/**
	 * Tests trying to create an Identity with an email that already belongs to
	 * another Indentity
	 */
	@Test
	...
	/**
	 * Tests returning a list of all identities
	 */
	@Test
	...
	/**
	 * Tests finding an identity by email
	 */
	@Test
